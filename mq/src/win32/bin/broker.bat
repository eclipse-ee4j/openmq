...
set _classes=%DEPENDLIBS%\javax.jms-api.jar;%IMQ_HOME%\..\..\share\opt\classes;%DEPENDLIBS%\grizzly-framework.jar;%DEPENDLIBS%\grizzly-portunif.jar;%DEPENDLIBS%\glassfish-api.jar;%DEPENDLIBS%\hk2-api.jar;%DEPENDLIBS%\grizzly-http.jar;%DEPENDLIBS%\grizzly-http-server.jar;%DEPENDLIBS%\grizzly-http-servlet.jar;%DEPENDLIBS%\jakarta.servlet-api.jar;%DEPENDLIBS%\grizzly-websockets.jar;%DEPENDLIBS%\javax.json.jar;%DEPENDLIBS%\jhall.jar;%DEPENDLIBS%\jakarta.transaction-api.jar;%DEPENDLIBS%\fscontext.jar;%DEPENDLIBS%\audit.jar;%DEPENDLIBS%\bdb_je.jar;%IMQ_EXTERNAL%\*
