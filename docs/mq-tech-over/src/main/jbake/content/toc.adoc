type=page
status=published
title=Eclipse Open Message Queue Technical Overview, Release 6.9.0
next=lof.html
~~~~~~
Eclipse Open Message Queue Technical Overview, Release 6.9.0
============================================================
...
link:mq-and-jakarta-ee.html#aerdu[5 Message Queue and Jakarta EE]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

* link:mq-and-jakarta-ee.html#aerdv[JMS/Jakarta EE Programming: Message-Driven
Beans]
