...
[[aenav]][[GMRLN00017]][[message-queue-6.1-supported-platforms-and-components]]

Message Queue 6.1 Supported Platforms and Components
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This section covers the following topics regarding Message Queue 6.1
system requirements:
