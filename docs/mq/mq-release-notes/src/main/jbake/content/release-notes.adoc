...
this document before you begin using Message Queue 5.1.1.
...
* link:#CHDFAIFD[About Message Queue 5.1.1]
* link:#aenav[Message Queue 5.1 Supported Platforms and Components]
* link:#CHDCIIHC[Bugs Fixed in Message Queue 5.1.1]
* link:#ggrur[About Message Queue 5.1]
...
The following table lists the dates for all 4.x and 5.x releases of the
...
[[CHDFAIFD]][[about-message-queue-5.1.1]]
...
Message Queue 5.1.1 is an incremental release participating in the 5.0
release of GlassFish Server. Message Queue 5.1.1 can also be downloaded
from
https://javaee.github.io/openmq/Downloads.html.[https://javaee.github.io/openmq/Downloads.html]

Unlike previous releases of Message Queue, the Message Queue 5.1.1
binary release does not include the C-API library although the C-API
source code is available at
https://github.com/javaee/openmq[]`https://github.com/javaee/openmq`
...
[[aenav]][[GMRLN00017]][[message-queue-5.1-supported-platforms-and-components]]

Message Queue 5.1 Supported Platforms and Components
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This section covers the following topics regarding Message Queue 5.1
system requirements:
...
As a participant in the 4.1 release of GlassFish Server, Message Queue
...
which is accessible at (`https://javaee.github.io/glassfish/`).
...
In addition to the software components listed in the Oracle GlassFish
Server 4.1 Certification Matrix, link:#gcuzg[Table 1-3] shows components
...
Message Queue 5.1 is installed as a sub-directory of the GlassFish 4.1
installation. For installation information, see the
https://javaee.github.io/glassfish/doc/4.0/installation-guide.pdf[GlassFish
...
* Message Queue 5.1 must be used with Java SE 7. This general JMS 2.0
...
https://javaee.github.io/glassfish/doc/5.0/administration-guide.pdf[Open
...
https://github.com/javaee/openmq/issues[OpenMQ Issues.] Please check
...
Oracle GlassFish Server Message Queue contains the following set of
...
* Use connection factories of type `javax.jms.ConnectionFactory` or
