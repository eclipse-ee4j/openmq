...
of release of Message Queue 6.0.0. New features and enhancements, known
issues and limitations, and other information are addressed here. Read
this document before you begin using Message Queue 6.0.0.
...
* link:#CHDFAIFD[About Message Queue 6.0.0]
* link:#aenav[Message Queue 6.0 Supported Platforms and Components]
...
[[CHDFAIFD]][[about-message-queue-6.0.0]]

About Message Queue 6.0.0
~~~~~~~~~~~~~~~~~~~~~~~~~
...
Message Queue 6.0.0 conforms to Jakarta Messaging 3.0 and is
integrated into GlassFish 6.0 which conforms to the Jakarta EE 9.
In addition, Message
Queue provides features that go beyond the JMS specification to meet the
needs of large-scale enterprise deployments.

Unlike previous releases of Message Queue, the Message Queue 6.0.0
