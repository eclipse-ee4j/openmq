...
`javax.jms.Session`; the fifth (`NO_ACKNOWLEDGE`) is defined in the
...
|=======================================================================
|Value |Utility Constant |String Representation |Meaning
|`1` |`javax.jms.Session``.``AUTO_ACKNOWLEDGE` |`AUTO_ACKNOWLEDGE`
|Auto-acknowledge mode

|`2` |`javax.jms.Session``.``CLIENT_ACKNOWLEDGE` |`CLIENT_ACKNOWLEDGE`
|Client-acknowledge mode

|`3` |`javax.jms.Session``.``DUPS_OK_ACKNOWLEDGE` |`DUPS_OK_ACKNOWLEDGE`
|Dups-OK-acknowledge mode

|`32768` |`com.sun.messaging.jms.Session``.``NO_ACKNOWLEDGE`
|`NO_ACKNOWLEDGE` |No-acknowledge mode

|`0` |`javax.jms.Session``.``SESSION_TRANSACTED` |`SESSION_TRANSACTED`
