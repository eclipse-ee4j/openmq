...
of release of Message Queue 6.9.0. New features and enhancements, known
issues and limitations, and other information are addressed here. Read
this document before you begin using Message Queue 6.9.0.
...
* link:#CHDFAIFD[About Message Queue 6.9.0]
* link:#aenav[Message Queue 6.9 Supported Platforms and Components]
* link:#CHDCIIHO[Bugs Fixed in Message Queue 6.9.0]
* link:#CHDCIIHN[Bugs Fixed in Message Queue 6.8.0]
...
|May 2026 |Release of this document for Message Queue 6.9.0

|March 2026 |Release of this document for Message Queue 6.8.0
...
[[CHDFAIFD]][[about-message-queue-6.9.0]]

About Message Queue 6.9.0
~~~~~~~~~~~~~~~~~~~~~~~~~
...
Message Queue 6.9.0 conforms to Jakarta Messaging 3.1.
In addition, Message
Queue provides features that go beyond the JMS specification to meet the
needs of large-scale enterprise deployments.

Like previous release of Message Queue, the Message Queue 6.9.0
...
[[CHDCIIHO]][[bugs-fixed-in-message-queue-6.9.0]]

Bugs Fixed in Message Queue 6.9.0
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
https://github.com/eclipse-ee4j/openmq/milestone/42?closed=1[OpenMQ
Issues] that are addressed in Message Queue 6.9.0.

=======================================================================

[[CHDCIIHN]][[bugs-fixed-in-message-queue-6.8.0]]

Bugs Fixed in Message Queue 6.8.0
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
There are some additional issues listed at github location
https://github.com/eclipse-ee4j/openmq/milestone/40?closed=1[OpenMQ
Issues] that are addressed in Message Queue 6.8.0.
